...
export class CreateEntry1641486041395 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "entry_status_item" ("id" SERIAL NOT NULL, "entryId" integer NOT NULL, "statusItemId" integer NOT NULL, "value" real NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_8d4f5742b6b22f4e82d96a83c65" PRIMARY KEY ("id"))`);
